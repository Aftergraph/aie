...
- add deterministic TCK checkout/venv preparation with commit and package-version verification
...
- emit `AIE_S2_A2A_INTEROP.json` with `BLOCKED_BY_S1` until the canonical S1 promotion attestation is PASS
