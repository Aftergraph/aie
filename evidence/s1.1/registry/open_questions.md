...
4. **When should S2 (A2A) promotion start?** RESOLVED. S2 promotion is PASS with all three legs (direct, SPIFFE, AIE) using real TCK runs (C-017, 2026-09-04 cycle 11). The S2 comparator is fully hardened with NOT_TESTED/SKIPPED acceptance (C-015), shared upstream FAIL demotion (C-016), and TCK exit code 1 acceptance for test failures. S2 promotion report: `/home/nora/aie-evidence/s2-promotion/AIE_S2_A2A_INTEROP.json`.
