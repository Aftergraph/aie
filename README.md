...
The S1.2 runner-portability branch was locally verified at **118/118 tests passing** before integration. This does not satisfy the external interoperability gate.
